...
class FaceModel:
  ...
  def __init__(self, args):
    ...
    print("_vec is", args.image_size, _vec)
    assert len(_vec) == 2
  ...
  def get_input(self, face_img):
    ...
    self.detect_face_time += (end-start)
    # print("get face time: ", end-start)
    if ret is None:
      return None
    bbox, points = ret
    if bbox.shape[0] == 0:
  ...
  def get_feature(self, aligned):
    ...
    self.get_feature_time += (end-start)
    # print("get feature time is:", end-start)
    return embedding
